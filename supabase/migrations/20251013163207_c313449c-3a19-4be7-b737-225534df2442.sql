-- Update handle_new_user function to include both Bookmaker and Exchange versions for Betfair and Betflag
...
BEGIN
  ...
  INSERT INTO public.books (user_id, nome, metodo, stato, predefinito) VALUES
    ...
    (NEW.id, 'Betfair', 'Bookmaker', 'Abilitato', false),
    (NEW.id, 'Betfair', 'Exchange', 'Abilitato', false),
    (NEW.id, 'Betflag', 'Bookmaker', 'Abilitato', false),
    (NEW.id, 'Betflag', 'Exchange', 'Abilitato', false),
