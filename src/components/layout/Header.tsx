...
const navigation = [
  ...
  { name: 'Puntate', href: '/puntate', icon: Zap },
  { name: 'Rapide', href: '/rapide', icon: Zap },
  { name: 'Conti', href: '/conti', icon: FileText },
  { name: 'Depositi/Prel.', href: '/depositi', icon: ArrowRightLeft },
  { name: 'Bilancio', href: '/bilancio', icon: Scale },
  { name: 'Archiviate', href: '/archiviate', icon: Archive },
  { name: 'Wallets', href: '/wallets', icon: Wallet },
  { name: 'Promemoria', href: '/promemoria', icon: Clock },
];
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-gradient-to-r from-primary to-accent shadow-sm">
